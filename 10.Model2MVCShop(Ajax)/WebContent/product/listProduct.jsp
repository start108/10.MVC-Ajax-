	...
	<script type="text/javascript">
		...
		//==>"검색" ,  userId link  Event 연결 및 처리
		 $(function() {
			...
			$("input[value='배송하기']").on("click", function(){
				self.location=""
			})
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tr>
		...
		<td class="ct_list_b" width="180">
			상품명<br>
			<h7>(상품 클릭= 상세정보)</h7>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150">상품 등록일</td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150">배송상태 </td><!-- 150 -->
		<td class="ct_line02"></td>
	...
	<tr>
		...
		<tr class="ct_list_pop">
			...
			<c:if test="${param.menu eq 'manage' && product.proTranCode eq '1  '}">				
