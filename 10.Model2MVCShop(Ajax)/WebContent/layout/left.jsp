		...
		//==> jQuery 적용 추가된 부분
		 $(function() {
			...
			//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
		 	...
		 	$( ".Depth03:contains('상품 검색')" ).on("click" , function() {
				//Debug..
				//alert(  $( ".Depth03:contains('상품 검색')" ) );
		 		$(window.parent.frames["rightFrame"].document.location).attr("href","/product/listProduct?menu=search");
			});
		 	
		 	/*$( ".Depth03:contains('게시판 관리')" ).on("click" , function() {
				//Debug..
				//alert(  $( ".Depth03:contains('상품 검색')" ) );
		 		$(window.parent.frames["rightFrame"].document.location).attr("href","/product/postProduct");
			});*/
