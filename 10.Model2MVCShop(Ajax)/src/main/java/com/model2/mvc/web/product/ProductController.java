...
public class ProductController {
	...
	public String addProduct( @ModelAttribute("product") Product product ) throws Exception {
		//ModelAttribute==> getParameter(set...해줌)
		...
		System.out.println("18181818181");
		productService.addProduct(product);
		System.out.println("191919199191");
		return "forward:/product/addProductView.jsp";
	}
	...
	public void getJsonProduct(@PathVariable int prodNo, @ModelAttribute("product") Product product01, Model model ) throws Exception{
		//PathVariable==> URL경로에 변수를 넣어줌. CSV하여 받아와야하지만 직접 파싱하지 않고 받아옴.
